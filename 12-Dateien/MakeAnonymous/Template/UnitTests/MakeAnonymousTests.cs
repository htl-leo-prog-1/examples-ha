...
public class MakeAnonymousTests
{
    [Fact]
    public void T01_CheckArg_WrongCount()
    {
        Program.Main(new string[2]).Should().Be(1);
    ...
    {
        var fileNameSrc = "Games.csv";

        //make a copy of the file => do not influence other unittests.
        var fileName = "GamesAnonymous.csv";
        File.Copy(fileNameSrc, fileName, true);
