...
namespace UnionExpect
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            TryUnion(new[] {1, 1, 3, 5, 7, 9, 1, 3}, new int[] {0, 1, 2, 3});
            Console.WriteLine("===========");

            Console.WriteLine("Alle gleich");
            TryUnion(new[] {1, 1, 3, 5}, new int[] {1, 3, 3, 5});
            Console.WriteLine("===========");
        ...
        private static void TryUnion(int[] arA, int[] arB)
        {
            PrintArray("Feld A: ", arA);
            PrintArray("Feld B: ", arB);

            var result = SetTools.Union(arA, arB);
