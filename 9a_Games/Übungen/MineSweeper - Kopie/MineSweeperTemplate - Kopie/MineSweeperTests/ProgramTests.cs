...
namespace MineSweeper.Tests
{
    ...
    public class ProgramTests
    {
        ...
        {
            bool[,] minesBoard;
            minesBoard = Program.HideMines(10, 5);
        ...
        {
            bool[,] minesBoard;
            minesBoard = Program.HideMines(25, 5);
            Assert.AreEqual(25, Program.CountMinesOnBoard(minesBoard), "keine 25 Minen im Feld");
        }
        ...
        {
            bool[,] minesBoard;
            minesBoard = Program.HideMines(0, 5);
