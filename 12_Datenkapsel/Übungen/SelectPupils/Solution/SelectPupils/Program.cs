...
namespace SelectPupils
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            var pupils = ReadPupilsFromCsv(fileName);
            var pupilsGrade = FilterByGrade(pupils);
            var pupilsSorted = SortByGrade(pupilsGrade);
        ...
        public static Pupil[] ReadPupilsFromCsv(string fileName)
        {
            ...
            var pupils = new Pupil[lines.Length - 1]; // ignore headline
        ...
        {
            int count = 0;
            var filteredPupils = new Pupil[pupils.Length];
        ...
        public static Pupil[] SortByGrade(Pupil[] pupils)
        {
            ...
            {
                int min = i;
                var gradeMin = CalculateGradeAverage(pupils[min]);

                for (int j = i + 1; j < pupils.Length; j++)
                {
                    var grade = CalculateGradeAverage(pupils[j]);
