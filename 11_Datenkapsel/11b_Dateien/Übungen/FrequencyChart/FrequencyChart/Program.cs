...
namespace FrequencyChart
{
    class MainClass
    {
        ...
        static string TrimTextForLabel(string text, int toLength)
        {
            return "";
        }
        ...
        static int GetEmptySpaceAfterLabelText(string text, int labelWidth)
        {
            return -1;
        }
        ...
        static string MakeAnAxisLabel(string text, int labelWidth)
        {
            return "";
        }
        ...
        static int GetLargestValueInColumn(string[,] fileContent, int dataColumn)
        {
            return 0;
        }
        ...
        static string MakeXAxisLabels(string[,] table, int labelColumn, int labelWidth)
        {
            return "";
        }
