...
namespace TadeotStatistics
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string[] lines = File.ReadAllLines("Besucherzahlen-2020.csv", Encoding.Default);
        ...
        private static void WriteToFile(InfoQuelle[] infoQuellen, int gesamtAnzahl)
        {
            ...
            {
                lines[i] = string.Format("{0,-40} {1,5:f2}%", infoQuellen[i].Bezeichnung, (infoQuellen[i].Anzahl * 100.0) / gesamtAnzahl);
        ...
        private static void CountVistorsPerInfoSource(InfoQuelle[] infoQuellen, string[] lines)
        {
            foreach (string line in lines)
            {
                ...
                string textInfoQuelle = elemente[6];
        ...
        private static InfoQuelle[] ExtractInfoSources(string[] lines)
        {
            ...
            {
                string[] elemente = lines[i].Split(';');
                InsertInfoSourceWithoutDuplicate(textInfoQuellen, elemente[6]);
            }
            int anzahl = 0;
