...
public sealed class TicTacToeTests
{
    ...
    public void CheckWinner(int[][] fieldsToSet, int expectedIndex)
    {
        ...
        int winnerIdx = TicTacToe.CheckWinner();
    ...
    public void GetPlayerIndexFromCell(int row, int col, int expectedIndex)
    {
        ...
        int playerIndex = TicTacToe.GetPlayerIndexFromCell(row, col);
    ...
    {
        int column = TicTacToe.GetColFromPosition(position, row);
    ...
    {
        int row = TicTacToe.GetRowFromPosition(position);
    ...
    {
        bool isValid = TicTacToe.CheckPositionValid(position);
    ...
    {
        bool posValid = TicTacToe.CheckPosition(position);
    ...
    public void GetPosition_Free(int position, bool expected)
    {
        ...
        bool isFree = TicTacToe.CheckPosition(position);
