...
namespace SkiJumpVoter.Tests
{
    ...
    public class ProgramTests
    {
        ...
        {
            Assert.AreEqual(69, CalculateLengthPoints(125), 0.001, "125 Meter ergibt 69 Weitenpunkte");
        }
        [TestMethod()]
        public void T12_CalculateLengthPointsTest_Minimum()
        {
            Assert.AreEqual(-66, CalculateLengthPoints(50), 0.001,  "50 Meter ergibt -66 Weitenpunkte");
        }
