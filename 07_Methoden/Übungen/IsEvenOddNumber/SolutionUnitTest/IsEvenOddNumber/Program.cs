 ...
 *              Musterlösung-HA
 *--------------------------------------------------------------
 * Description: IsEvenOddNumber with UnitTests
 *--------------------------------------------------------------
 */

using System;

namespace IsEvenOddNumber
{
    public class Program
    {
        ...
        public static bool IsEvenOddNumber(int number)
        {
        ...
        private static int SumOfDigitEven(int number)
        {
            return SumOfDigit(number, 0);
        }

        private static int SumOfDigitOdd(int number)
        {
            return SumOfDigit(number, 1);
        }

        private static int SumOfDigit(int number, int remainder)
        {
            int sumOfDigit = 0;
